...
_e(function (E, $) {
  ...
  E.plugin(function () {
    ...
    function render() {
      ...
      $valueContainer.append($toolbar).append($dragPoint);
      isRendered = true;
    }
    ...
    function bindDragEvent() {
      ...
      function mousemove(e) {
        ...
        // --- 定位 dragpoint ---
        $dragPoint.css({
          top: imgPosition.top + $currentImg.outerHeight(),
          left: imgPosition.left + $currentImg.outerWidth()
        });
      ...
      $dragPoint.on('mousedown', function (e) {
        ...
        E.$document.on('mouseup._dragResizeImg', function () {
          // 取消绑定
